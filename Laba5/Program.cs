...
namespace Laba1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //var listner1 = new Listener();
            //var listner2 = new Listener();

            //var magazineCollection1 = new MagazineCollection()
            //{
            //    NameCollection="First Collection"
            //};
            //magazineCollection1.MagazineAdded += listner1.OnMagazineAdded;
            //magazineCollection1.MagazineReplaced += listner1.OnMagazineReplaced;

            //var magazineCollection2 = new MagazineCollection()
            //{
            //    NameCollection = "Second Collection"
            //};
            //magazineCollection2.MagazineAdded += listner2.OnMagazineAdded;
            //magazineCollection2.MagazineReplaced += listner2.OnMagazineReplaced;

            //magazineCollection1.AddDefaults();
            //magazineCollection2.AddDefaults();

            //magazineCollection1.Replace(1, new Magazine("Test1", Frequency.Montly, new DateTime(2021, 2, 12),7));
            //magazineCollection2.Replace(1, new Magazine("Test2", Frequency.Yearly, new DateTime(2020, 7, 19), 3));

            //magazineCollection1[0] = new Magazine("Test1_indexer", Frequency.Montly, new DateTime(2021, 6, 18), 3);
            //magazineCollection2[0] = new Magazine("Test2_indexer", Frequency.Weekly, new DateTime(2020, 9, 8), 8);


            //Console.WriteLine(listner1.ToString());
            //Console.WriteLine(listner2.ToString());
            #endregion

            var magazine = new Magazine("Forbes", Frequency.Weekly, DateTime.Now, 5)
            {
                Articles = new List<Article>()
                {
                    new Article(
            ...
            var copyMagazine = magazine.DeepCopy();
            Console.WriteLine("\n--Origin--\n");
            Console.WriteLine(magazine);

            Console.WriteLine("\n--Copy--\n");
            Console.WriteLine(copyMagazine);

            Console.WriteLine("Input name file(.dat):");
            var filename = Console.ReadLine(); 
            if (File.Exists(filename))
            {
                if (magazine.Load(filename))
                {
            ...
            {
                Console.WriteLine("The file don`t exists.File will created");
            ...
            if (Magazine.Load(filename, magazine))
            {
                Console.WriteLine("-----Data uploaded successfully!-----");
            }
            ...
            if (Magazine.Save(filename, magazine))
            {
                Console.WriteLine("-----Data save successfully!-----");
            }
